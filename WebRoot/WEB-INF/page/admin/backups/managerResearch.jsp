...
<head>
	...
	<c:if test="${empty param.lite}">
	<script type="text/javascript" src="js/managerResearch.js"></script>
	</c:if>
	<c:if test="${!empty param.lite}">
	<script>
		var subject = "${subject}";
	...
	<script type="text/javascript" src="js/managerResearchLite.js"></script>
	</c:if>
</head>
<body>
</body>
