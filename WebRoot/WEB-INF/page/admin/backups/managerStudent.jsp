...
<head>
	...
	<c:if test="${empty param.clazzId || !empty param.upgrade}">
	<script type="text/javascript" src="js/managerStudent.js"></script>
	</c:if>
	<c:if test="${!empty param.clazzId && empty param.upgrade}">
	<script type="text/javascript" src="js/managerStudentClazz.js"></script>
	</c:if>
</head>
<body>
