...
<head>
	...
	<script type="text/javascript" src="js/managerResearchLib.js"></script>
	<script>
		var SHOW_OLD = ${isOld};
		var STUDY_YEAR_ID = "${sy.id}";
		var STUDY_YEAR_NAME = "${myf:escape(sy.name)}";
		var BACK_BUTTON = ${!empty param.back};
		var TOPIC_LIB_ID = "${param.topicLibId}" ;
	</script>
</head>
<body>
</body>
