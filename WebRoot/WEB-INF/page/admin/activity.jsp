...
<head>
	...
	<link href="../js/ext-plugin/date-time-ux.css" rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript" src="../js/ext-plugin/date-time-ux.js"></script>
	...
	<script type="text/javascript" src="js/editActivity.js"></script>
