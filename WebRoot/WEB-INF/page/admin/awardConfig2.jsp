...
<head>
	...
	<script type="text/javascript">
		...
		window.ftmap = {};
		<c:forEach var="i" items="${festivalMap}">
		ftmap["<c:out value='${i.key}' escapeXml='true'/>"] = "${i.value}";
		</c:forEach>
		
	</script>
	<script type="text/javascript" src="js/const.js"></script>
	<script type="text/javascript" src="js/server-top.js"></script>
	<script type="text/javascript" src="js/editAwardConfig.js"></script>
	<script type="text/javascript" src="js/editAwardConfig-highRankAwards.js"></script>
	<script type="text/javascript" src="js/awardConfig2.js"></script>
</head>
<body>
</body>
</html>