...
<head>
	...
	<style>#tablogin td{ padding-top:15px;padding-bottom:35px; }</style>
</head>
<body>
	<div id="loginpanel">
		<form name="frm_login" method="post" action="adminLogin.do?method=adminLogin2nd">
		  ...
		  <tr>
		    <td width="553" height="293" align="center" valign="middle" bgcolor="#e7e7e7">
		    	...
		    	<table id="tablogin" width="390" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="87" align="center">安全码：</td>${message}
                    <td width="303"><input type="text" value="123" name="code" id="userpass" /></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>
	...
	<script>
		window.document.onload=document.getElementById("userpass").focus();
	</script>
</body>
</html>