...
Ext.onReady(function(){
	...
	var uppanel = function(xid, xname, subId)
	{ 
		var titleName = "修改";
		if(xid=="")
		{
	...
	toolbar.add(
			...
			new Ext.Button({
				...
				var subId = records[0].data.subId;
			    uppanel(id,name,subId);
				}
			})
	);
	...
	var grid = new Ext.grid.GridPanel({
		...
		columns:[//对应的列
		         sm,//对应ID,
		         {header:'类型ID',width:100,dataIndex:'subId',sortabel:true},
