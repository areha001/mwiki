	...
	searchGold.add('-',
	       ...
	       new Ext.form.MultiSelect({
	    	   ...
	    	   afterSure:function(){
	    		        ...
	    		        getServerList(c);
	    		        for(var i =0; i < serverList.getCount();i++){
	    		        //	console.log(serverList.getAt(i));
	    		        }
	    		   },
...
//	    		    },
	...
	function exportExcel(){
		...
		var url='prepaidList.do?method=findprepaidList&target=excel&' + Ext.urlEncode(params);
		window.open(url);	
	}
...
//	   autoLoad:true,
		...
		proxy : new Ext.data.HttpProxy({
			url:'prepaidList.do?method=findprepaidList'//点击进入
			//baseParams:{hello:1}
			//alert();
		})
...
//	var outcolums = new Ext.grid.ColumnModel(outcolumnArr);
	...
	var grid = new Ext.grid.GridPanel({
		...
		columns:[
				...
				{header:'玩家ID',width:130,dataIndex:'uid',sortable:true},
				{header:'玩家名',width:130,dataIndex:'name',sortable:true},
				{header:'充值金额',width:130,dataIndex:'amount',sortable:true},
