(function () {
    ...
    var buttonCreator = function (methodName, pageTitle, extraWidth) {
        ...
        var xHistory = function (user) {
            ...
            function resetDailyQuest() {
                ...
                Ext.Ajax.request({
                    url: "gmEdit.do?method=editDailyQuest",
                    params: {
            ...
            tbar.add(
                ...
                new Ext.form.Label({html: "<b>活跃度</b>: ", style: 'padding:8px 00px 8px 20px;'}),
            ...
            var grid = new Ext.grid.GridPanel({
                ...
                columns: [//对应的列
                    ...
                    {header: '任务名 ', width: 130, dataIndex: 'name', sortable: true},
    ...
    window.extraButton2.push({text: '每日任务', iconCls: 'editButton', func: buttonCreator("showDailyQuest", "每日任务")});
})();